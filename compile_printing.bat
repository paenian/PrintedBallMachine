...
#ball return
openscad -o ball_return/ball_return_inlet_2.stl -D part=0 ball_return/ball_return.scad &
openscad -o ball_return/ball_return_inlet_3.stl -D part=2 ball_return/ball_return.scad &
